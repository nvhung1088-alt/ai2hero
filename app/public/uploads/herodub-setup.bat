...
echo [INFO] Dang tai herodub_worker.py tu ai2hero.com (v20 - 2-Stage Split Flow ^& Auto-Cleanup)...
curl -s -L -o herodub_worker.py "https://ai2hero-flax.vercel.app/uploads/herodub_worker.py?v=20"
