...
import { VideoListClient } from '../../../dashboard/video-list-client';
import { ExtensionStatusBadge } from '../../../dashboard/extension-status';
import { FileVideo } from 'lucide-react';

export default async function HeroVideoDynamicDashboard({
  params
}: {
