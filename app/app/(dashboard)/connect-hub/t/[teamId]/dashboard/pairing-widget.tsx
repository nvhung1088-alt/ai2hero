  ...
  return (
    <div className="bg-gray-900/40 border border-white/5 rounded-2xl p-5 shadow-sm backdrop-blur-xl space-y-4">
      <h3 className="text-xs font-extrabold text-gray-400 uppercase tracking-wider flex items-center gap-2">
        ...
        Liên kết HeroVideoMaker (Toonflow)
      </h3>
      
      <p className="text-[10px] text-gray-400 leading-relaxed font-medium">
        Đồng bộ kịch bản, ảnh và video trực tiếp từ Toonflow App local về workspace. Sinh mã 6 ký tự để kết nối thiết bị của bạn.
      </p>
      ...
      {code ? (
        <div className="bg-black/35 border border-white/5 p-4 rounded-xl flex flex-col items-center justify-center space-y-3 relative overflow-hidden animate-fade-in">
          ...
          <span className="text-3xl font-black tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-pink-500 select-all">
            {code}
          </span>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-1.5 px-3 py-3 bg-gradient-to-r from-orange-500 to-pink-500 hover:opacity-90 text-white rounded-xl text-xs font-black tracking-wide shadow-lg shadow-orange-500/10 transition-all cursor-pointer disabled:opacity-50"
        >
          {loading ? (
            <>
