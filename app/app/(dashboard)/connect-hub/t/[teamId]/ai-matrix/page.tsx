...
const TTS_MODELS = [
  ...
  },
  {
    ...
    priceLabel: '~$15',
    priceDesc: 'Tầm trung ($15/1M Char)',
  ...
  },
  {
    ...
    priceLabel: '~$12',
    priceDesc: 'Giá hợp lý (300.000đ/1M)',
  ...
  },
  {
    ...
    priceLabel: '~$4',
    priceDesc: 'Giá rẻ (100.000đ/1M Chars)',
...
const LLM_MODELS = [
  ...
  },
  {
    ...
    stars: 4,
    starLabel: 'Tốt (1M Context)',
    priceLabel: '$0.075 / $0.30',
    priceColor: 'text-green-400',
    priceDesc: 'Giá rẻ',
    speedIcon: <Zap className="h-3 w-3" />,
    speedLabel: 'Siêu tốc',
    speedColor: 'text-purple-400',
    bestFor: 'Trình duyệt video nhanh, Phân tích log số lượng lớn, Xử lý prompt dài giá rẻ.'
  },
  {
    id: 'deepseekv3',
    name: 'DeepSeek V3 / R1',
    stars: 5,
    starLabel: 'Xuất sắc (IQ Đỉnh)',
    ...
    speedLabel: 'Siêu tốc',
    speedColor: 'text-purple-400',
    bestFor: 'Lập trình thông minh, Suy luận chuyên sâu (Reasoning), CSKH AI cao cấp.'
  },
  {
    id: 'gpt4omini',
    name: 'GPT-4o-Mini',
