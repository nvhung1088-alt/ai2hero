...
export default async function ConnectHubDashboardPage() {
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-900/40 border border-white/5 rounded-2xl p-5 shadow-sm backdrop-blur-xl space-y-4">
            <div className="flex items-center justify-between border-b border-white/5 pb-2">
              ...
              <Link href="/connect-hub/logs" className="text-[10px] text-purple-400 hover:text-purple-300 font-bold select-none cursor-pointer">
                Xem hết
              </Link>
            </div>
