...
export default function DubGuidePanel({
  ...
  const winCmd = 'curl -o herodub-setup.bat https://ai2hero-flax.vercel.app/uploads/herodub-setup.bat?v=12 & herodub-setup.bat --server https://ai2hero-flax.vercel.app';
