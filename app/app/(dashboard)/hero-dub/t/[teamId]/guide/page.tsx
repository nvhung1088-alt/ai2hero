...
export default function HeroDubGuidePage() {
  ...
  const winCommand = `curl -o herodub-setup.bat https://ai2hero-flax.vercel.app/uploads/herodub-setup.bat?v=12 & herodub-setup.bat --server https://ai2hero-flax.vercel.app`;
                  ...
                  <div>
                    ...
                    <div className="bg-black border border-white/10 rounded-xl p-3 flex items-center justify-between gap-4 font-mono text-green-400/90 text-[11px]">
                      <span className="select-all overflow-x-auto whitespace-nowrap">
                        curl -o herodub-setup.bat https://ai2hero-flax.vercel.app/uploads/herodub-setup.bat?v=12 & herodub-setup.bat --server https://ai2hero-flax.vercel.app
                      </span>
                      <button
                        onClick={() => handleCopy('curl -o herodub-setup.bat https://ai2hero-flax.vercel.app/uploads/herodub-setup.bat?v=12 & herodub-setup.bat --server https://ai2hero-flax.vercel.app')}
