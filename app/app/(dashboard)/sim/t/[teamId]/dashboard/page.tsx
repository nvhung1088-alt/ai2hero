...
import SimGuideBox from '../../../dashboard/guide-box';

export const revalidate = 0; // Tắt cache để load real-time data

export default async function SimDashboardPage({ params }: { params: Promise<any> }) {
        ...
        <div className="lg:col-span-2 bg-gray-900/50 border border-white/10 rounded-2xl p-6 flex flex-col justify-between">
                ...
                topRiskySims.map((sim) => (
                  <div key={sim.id} className="py-3 flex items-center justify-between gap-4 group">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <Link
                        href={`/sim/t/${teamId}/assets?search=${encodeURIComponent(sim.value)}`}
          ...
          <div className="border-t border-white/5 pt-4 mt-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              <Link href={`/sim/t/${teamId}/assets`} className="p-3 bg-white/[0.02] border border-white/5 hover:border-white/15 hover:bg-white/[0.04] rounded-xl text-center transition-all group">
              ...
              <Link href={`/sim/t/${teamId}/accounts`} className="p-3 bg-white/[0.02] border border-white/5 hover:border-white/15 hover:bg-white/[0.04] rounded-xl text-center transition-all group">
              ...
              <Link href={`/sim/t/${teamId}/alerts`} className="p-3 bg-white/[0.02] border border-white/5 hover:border-white/15 hover:bg-white/[0.04] rounded-xl text-center transition-all group">
              ...
              <Link href={`/sim/t/${teamId}/history`} className="p-3 bg-white/[0.02] border border-white/5 hover:border-white/15 hover:bg-white/[0.04] rounded-xl text-center transition-all group">
