...
def build_rich_vietnamese_description(title_vi, raw_title="", sample_subs=None):
    ...
    Tự động biến đổi theo ĐÚNG THỂ LOẠI: Chú heo bông súp lơ, Hoạt hình 3D, Phim drama, Ẩm thực, Khoa học, Sinh tồn, Đời sống...
...
{{
  ...
  "hashtags": "#theloai1 #theloai2 #hashtag3 #xuhuong #phimhay"
    ...
    # Đảm bảo description không còn ký tự Trung Quốc và có cấu trúc bài bản, tuyệt đối không dùng văn mẫu sáo rỗng
