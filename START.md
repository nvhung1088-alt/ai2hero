...
- **Tiến độ tích hợp:**
  ...
  - `[x]` 👁️ **Tích Hợp Multimodal Vision Copywriting & Chuẩn Hóa Redesign Thumbnail Không Khung Đen**:
    ...
    - **Chuẩn Hóa Thiết Kế Ảnh Bìa (Gemini Imagen 3)**: Quy định bắt buộc trong prompt gửi Gemini: Xóa sạch chữ tiếng Trung và ghi lại chữ tiếng Việt lên **đúng vị trí chữ cũ**, giữ nguyên 100% nhân vật và bối cảnh. Xóa bỏ hoàn toàn tấm biển đen `BOTTOM PLATE` (từng che 32% chiều cao ảnh) trong engine cục bộ, đảm bảo ảnh bìa thoáng mắt, tự nhiên và không bị che khuất chủ thể.
